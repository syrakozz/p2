...
// Naics maps NAICS code to business establishment.
var Naics = map[string]string{
	...
	"488510": "Freight Transportation Arrangemen",
	...
	"921":    "Executive, Legislative, and Other General Government Suppor",
	"9211":   "Executive, Legislative, and Other General Government Suppor",
	...
	"92119":  "Other General Government Suppor",
	"921190": "Other General Government Suppor",
	...
	"925":    "Administration of Housing Programs, Urban Planning, and Community Developmen",
	"9251":   "Administration of Housing Programs, Urban Planning, and Community Developmen",
	"92511":  "Administration of Housing Programs",
	"925110": "Administration of Housing Programs",
	"92512":  "Administration of Urban Planning and Community and Rural Developmen",
...
// NaicsItem contains an NAICS code/value
type NaicsItem struct {
	Display string `json:"display"`
	Value   string `json:"value"`
}

// GetNaics returns all NAICS code/value pairs in sorted order where the code less that a given length.
func GetNaics(length int) []NaicsItem {
	items := []NaicsItem{}

	for v, d := range Naics {
		// length 0 or 1 means all
		if length >= 2 && len(v) > length {
			continue
		}

		items = append(items, NaicsItem{Display: d, Value: v})
	}
